        ...
        <div class="container-fluid">
            <div class="row">
                <?php foreach($items as $key=>$element): ?>
                    <div class="col-xs-12 col-lg-3 col-md-6 no-padding element_portfolio group<?= $element->group_id ?>" style="background-image: url('<?= $element->company_logo_id->getSource() ?>');">
                        <div class="portfolio-fade-in" style="background-color:<?= $element->color ?>" data-target="#exampleModal1" data-href="<?= $element->link ?>" data-description="<?= $element->description ?>" data-img="<?= $element->main_img_id->getSource() ?>">
